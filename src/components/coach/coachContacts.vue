...
<template>
  ...
  <div v-if="isThereContact" class="space-y-4">
    <div class="cardDefaults" v-for="contact in allContact" :key="contact" >
        ...
        <coach-items :selectedCoachData="contact.selectedCoach" :selectedCoachId="contact.id"></coach-items>
        <div>
    ...
    <div v-else class="cardDefaults text-bold ">
      ...
      <router-link class="font-bold text-green-500" to="/coaches">Check Coachs!</router-link>
    </div>
  </BaseContainer>
</template>
